...
function render(particles2) {
  ...
  for (let i = 0; i < particles2; i++) {
    const i3 = 3 * i;
    sizes2[i] += 0.1 * Math.cos(1e-3 * i / 2 * (Math.random() * 2 + 1) + elapsedTime * 0.5);
    position[i3 + 0] += 1e-3 * Math.cos(0.01 * i + elapsedTime * 0.5);
  }
...
//# sourceMappingURL=index-9744660b.js.map
